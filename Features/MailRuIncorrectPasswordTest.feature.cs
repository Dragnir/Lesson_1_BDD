...
namespace Lesson_11_BDD.Features
{
    ...
    [NUnit.Framework.DescriptionAttribute("MailRuIncorrectPasswordTest")]
    public partial class MailRuIncorrectPasswordTestFeature
    {
...
#line 1 "MailRuIncorrectPasswordTest.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "MailRuIncorrectPasswordTest", "\tIn order to verify incorrect password\r\n\tAs a existing user\r\n\tI want be able to s" +
                    "ee error message after emter incorrect password", ProgrammingLanguage.CSharp, featureTags);
...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 8
 testRunner.Given("I open official mail ru site", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 9
